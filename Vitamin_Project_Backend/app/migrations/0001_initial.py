    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tab', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tabs',
                                          to='app.tabs')),
                ('tab_child',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='childs',
                                   to='app.tabchild')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ZoneID',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='strengths',
                                   to='app.zones')),
            ],
            options={
