        ...
        if tab_id == 1:
            ...
            try:
                if zip_code:
                    ...
                    if latitude > 0:
                        zone_data = switch(zone_name).objects.filter(LatitudeMin__lte=latitude,
                                                                     LatitudeMax__gte=latitude, NorthSouth='N')
                    else:
                        zone_data = switch(zone_name).objects.filter(LatitudeMin__lte=latitude,
                                                                     LatitudeMax__gte=latitude, NorthSouth='S')
                    ...
                    for itr in result:
                        ...
                        serializer2 = SunshineAvailabilitySerializer(sunshine_data, many=True,
